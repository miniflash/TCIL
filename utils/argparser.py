...
def init_params(train_type='train', verbose=True):
    ...
    if train_type in ['train', 'train_envelope', 'train_c2f', 'eval']:
        ...
        argparser.add_argument('--batch_size', default=4, type=int, #2
                               help='Training batch size')
        argparser.add_argument('--val_batch_size', default=20, type=int,
                               help='Validation batch size')
        argparser.add_argument('--num_workers', default=8, type=int, #4
    ...
    if train_type in ['train_envelope']:
        # argparser.add_argument('--CLstrategy', default=None, type=str, choices=['okd', 'fkd', 'kd','inpaint', 'fpkd'],
        #                     help='Number of steps for CL')
        # argparser.add_argument('--kd_par', default=0.1, type=float,
        #                     help='Number of steps for CL')

        # TCIL
        argparser.add_argument('--CLstrategy', default='tcil', type=str, choices=['tcil'],
                            help='knowledge constraint method for CIL')
        argparser.add_argument('--lambda_1', default=0.1, type=float,
                            help='weight for the loss PD')
        argparser.add_argument('--lambda_2', default=0.1, type=float,
                            help='weight for the loss OC')
